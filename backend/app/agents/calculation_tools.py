...
@function_tool
def convert_medical_units(value: str, from_unit: str, to_unit: str, parameter: str) -> str:
...
@function_tool
def check_visit_window_compliance(target_date: str, actual_date: str, window_before_days: str, window_after_days: str) -> str:
...
@function_tool
def calculate_change_from_baseline(baseline_value: str, current_value: str, parameter_name: str = "") -> str:
    ...
    magnitude_warning = abs(percentage_change) > 200 if percentage_change is not None else False
...
@function_tool
def calculate_creatinine_clearance(serum_creatinine_mg_dl: str, age_years: str, weight_kg: str, sex: str) -> str:
    ...
    try:
        ...
        if unit_lower == "days":
            ...
            return json.dumps({
                ...
                "supported_units": ["days", "weeks", "months", "years", "hours", "minutes", "business_days"]
            })
        ...
        if abs_days == 0:
            ...
            if remaining_days > 0:
                human_readable += f", {remaining_days} day{'s' if remaining_days > 1 else ''}"
        elif abs_days < 365:
            months = abs_days // 30
