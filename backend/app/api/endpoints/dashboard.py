...
async def get_query_metrics():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve query metrics: {str(e)}")
...
async def get_sdv_metrics():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve SDV metrics: {str(e)}")
...
async def get_trial_metrics():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve trial metrics: {str(e)}")
...
async def get_realtime_alerts():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve real-time alerts: {str(e)}")
...
async def get_realtime_activity():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve real-time activity: {str(e)}")
...
async def get_monitoring_alerts():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve monitoring alerts: {str(e)}")
...
async def clear_monitoring_alerts(alert_ids: Optional[List[str]] = None):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to clear monitoring alerts: {str(e)}")