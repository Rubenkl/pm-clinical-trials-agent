...
from app.agents.handoffs import HandoffRegistry, QueryAnalyzerHandoff, DataVerifierHandoff
...
class TestPortfolioManagerIntegration:
    ...
    def test_complex_workflow_with_multiple_agents(self):
        ...
        context = ClinicalTrialsContext()
        context.user_request = "Analyze safety data for all oncology trials and verify data quality"
    ...
    def test_workflow_with_handoff_registry(self):
        ...
        if applicable_handoffs:
            mock_agent_func = Mock(return_value={
                "analysis": {
    ...
    def test_error_handling_in_workflow(self):
        ...
        query_analyzer = Mock()
        query_analyzer.analyze.side_effect = Exception("Query analysis failed: Invalid input")
        ...
        assert "failed" in context.errors[0].lower() or "error" in context.errors[0].lower()
    ...
    def test_parallel_agent_coordination(self):
        ...
        context = ClinicalTrialsContext()
        context.user_request = "Provide comprehensive status update for trial CT-2024-001"
        context.trial_id = "CT-2024-001"
    ...
    def test_workflow_with_clinical_context_specialization(self):
        ...
        # Update compliance
        context.update_compliance("ethics_approval", True, {
    ...
    def test_agent_communication_patterns(self):
        ...
        context = WorkflowContext()
        context.user_request = "Generate comprehensive analysis report with verification"
