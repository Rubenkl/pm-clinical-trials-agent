...
class TestQueryAnalyzerSDK:
    ...
    def mock_openai_client(self):
        ...
        with patch('app.agents.query_analyzer_sdk.OpenAI') as mock_client:
            ...
            mock_message.content = [Mock(text=Mock(value=json.dumps({
                ...
                "suggested_actions": ["Review source document", "Clarify with site"],
    ...
    async def test_pattern_detection(self, query_analyzer):
        ...
        historical_data = [
            ...
            {"site_name": "Site C", "field_name": "Blood Pressure", "discrepancy_count": 8}
        ]
    ...
    async def test_regulatory_compliance_check(self, query_analyzer):
        ...
        compliance_result = await query_analyzer.check_regulatory_compliance(subject_data)
    ...
    def test_severity_assessment(self, query_analyzer):
        ...
        critical_result = query_analyzer.assess_medical_severity("myocardial infarction")
