...
from app.agents import query_analyzer, data_verifier, portfolio_manager, query_generator, query_tracker
...
class TestJSONStructureConsistency:
    ...
    def test_json_output_format_consistency(self):
        ...
        expected_patterns = {
            ...
            "data_verifier": ["match_percentage", "discrepancies", "verification_status"],
    ...
    def test_json_schema_field_types(self):
        ...
        for field_name, expected_type in field_type_patterns.items():
            ...
            assert expected_type in [str, int, float, list, dict, (int, float), (str, int)]
    ...
    def test_common_json_fields_across_agents(self):
        ...
        common_fields = {
            ...
            "status": {"type": str, "values": ["pending", "in_progress", "completed", "failed"]},
...
class TestAgentPromptEnhancement:
    ...
    def test_agent_instructions_include_json_requirement(self):
        ...
        for agent in agents:
            ...
            has_json_instruction = any(keyword in instructions for keyword in json_keywords)
