...
class TestQueryTrackerInternal:
    ...
    async def test_query_tracker_workflow_initialization(
        self, query_tracker, generated_query, workflow_context
    ):
    ...
    async def test_query_tracker_workflow_error_handling(self, query_tracker):
        ...
        invalid_context = {
            ...
            "input_data": {"query_id": None, "severity": "unknown"},  # Invalid query ID
        }
...
class TestQueryTrackerIntegration:
    ...
    async def test_portfolio_manager_query_tracker_orchestration(
    ...
    async def test_multi_agent_query_workflow(self, portfolio_manager):
        ...
        workflow_request = {
            ...
            "input_data": {
                "subject_id": "SUBJ001",
                "clinical_data": {"hemoglobin": "8.5", "source": "lab_report"},
            },
