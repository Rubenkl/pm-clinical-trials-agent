...
GROUND_TRUTH_DATASETS = [
    ...
    },
    {
        ...
        "edc_data": {
            ...
            "visit": "V2",
            "adverse_events": [],
            "vital_signs": {"systolic_bp": 130, "diastolic_bp": 85},
        },
        "source_data": {
            "subject_id": "S002",
            "visit": "V2",
    ...
    },
    {
        ...
        "edc_data": {
            "subject_id": "S004",
            "visit": "Screening",
            "demographics": {"age": 65, "weight": 75.5},
            "eligibility": {
        ...
        "source_data": {
            ...
            "eligibility": {
                ...
                "inclusion_violations": [
                    "Age > 60 years excluded per protocol amendment"
                ],
            },
        },
        "expected_discrepancies": [
    ...
    },
    {
        ...
        "edc_data": {
            "subject_id": "S005",
            "visit": "V1",
            "vital_signs": {"systolic_bp": 118, "diastolic_bp": 78, "heart_rate": 68},
    ...
    },
    {
        ...
        "edc_data": {
            ...
            "laboratory": {"glucose": 180, "cholesterol": 220},
            "adverse_events": [{"term": "Headache", "severity": "Mild"}],
        },
        "source_data": {
            "subject_id": "S006",
            "visit": "V3",
            ...
            "laboratory": {"glucose": 185, "cholesterol": 220},  # 5 point difference
            "adverse_events": [
...
CRITICAL_DATA_TEST_CASES = [
    ...
    },
    {
        ...
        "data": {
            ...
            "pregnancy_test": {"result": "Positive", "date": "2025-01-09"},
        },
        "expected_critical_fields": [
            {
    ...
    },
    {
        ...
        "data": {
            "subject_id": "S009",
            "vital_signs": {"systolic_bp": 120, "diastolic_bp": 80, "heart_rate": 70},
            "laboratory": {"glucose": 95, "cholesterol": 180},
        },
        "expected_critical_fields": [],
...
def calculate_accuracy_score(
    predicted_discrepancies: List[Dict],
    ...
    for expected in expected_discrepancies:
        ...
        for predicted in predicted_discrepancies:
            if (
                predicted.get("field") == expected["field"]
                and predicted.get("edc_value") == expected["edc_value"]
                and predicted.get("source_value") == expected["source_value"]
            ):
...
def calculate_performance_metrics(
    predicted_discrepancies: List[Dict], expected_discrepancies: List[Dict]
) -> Dict[str, float]:
    ...
    accuracy = (
        true_positives / len(expected_discrepancies) if expected_discrepancies else 0.0
    )
