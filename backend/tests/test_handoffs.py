...
class TestHandoffDefinition:
    ...
    def test_handoff_priority_ordering(self):
        ...
        low_priority = HandoffDefinition(
            name="low", target_agent="Agent1", description="Low priority",
            condition_func=lambda ctx: True, priority=1
        )
        high_priority = HandoffDefinition(
            name="high", target_agent="Agent2", description="High priority", 
            condition_func=lambda ctx: True, priority=10
        )
...
class TestHandoffIntegration:
    ...
    def test_portfolio_manager_to_query_analyzer_handoff(self):
        ...
        mock_analyzer = Mock(return_value={
            "analysis": {
    ...
    def test_query_analyzer_to_data_verifier_handoff(self):
        ...
        mock_verifier = Mock(return_value={
    ...
    def test_error_handling_handoff_chain(self):
        ...
        context.add_error("Query validation failed: Missing required parameter 'trial_id'")
        ...
        mock_error_handler = Mock(return_value={
            "error_resolution": {
